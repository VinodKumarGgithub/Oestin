          ...
          <div className="row mb-n60">
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-60">
              <div className="single-footer-widget">
                ...
                <p>
                  Lorem ipsum dolor sit amet, conse acteir our adipisicing
                  elit, sed do eiusmod the a tempor the incididunt ut labore et
                  dolore magnaa liqua. Ut enim minimn.
                </p>
          ...
          <div className="row justify-content-center">
            <div className="col-auto">
              <div className="footer-text text-center">
                <span>
                  © 2023 <b className="text-white">Oestin</b> Made with{" "}
